 ...
 * Plugin URI:        https://forhad.net/corona
...
function wpgpcv_admin_page_contents() {
	...
	?>
		...
		<div id="wpgp--card" class="card">
			...
			<input type="submit" formtarget="_blank" name="submit" id="submit" class="button button-primary" value="Open a Support Ticket" onclick="window.open('https://forhad.net/submit-ticket/', '_blank');">
			<p>Also check out our <a class="wpgp--link-support" target="_blank" href="https://wordpress.org/plugins/search/wpqode/">More Plugins</a>.</p>
